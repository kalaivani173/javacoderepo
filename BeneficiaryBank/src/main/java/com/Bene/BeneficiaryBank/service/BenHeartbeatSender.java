...
@Component
    public class BenHeartbeatSender {

        private static final Logger log = LoggerFactory.getLogger(BenHeartbeatSender.class);
        ...
        @Value("${payer.orgId:158888}")
        private String payerOrgId;

        public BenHeartbeatSender(HbtService hbtService, RestTemplate restTemplate) {
