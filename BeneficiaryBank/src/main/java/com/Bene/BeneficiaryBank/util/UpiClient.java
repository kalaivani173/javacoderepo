...
import com.Bene.BeneficiaryBank.dto.RespPay;
...
public class UpiClient {
    ...
    public void sendRespPay(RespPay respPay, String txnId) {
        ...
        try {
            ...
            System.out.println("---- Outgoing RespPAY CREDIT XML ----");
        ...
        HttpEntity<RespPay> entity = new HttpEntity<>(respPay, headers);
            ...
            System.err.println("Error posting RespPay CREDIT to UPI: " + e.getMessage());
            e.printStackTrace();
        }
    }
    }
