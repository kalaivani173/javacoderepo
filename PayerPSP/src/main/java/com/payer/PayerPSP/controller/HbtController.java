...
import com.payer.PayerPSP.util.XmlPrettyPrinter;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.*;
import com.payer.PayerPSP.dto.RespHbt;
...
public class HbtController {
    ...
    public String createReqHbt(@RequestParam(name = "custRef", required = false, defaultValue = "NA") String custRef) throws Exception {
        ...
        String reqHbtXml = XmlUtil.toXml(reqHbt, ReqHbt.class);
    ...
    public ResponseEntity<Ack> receiveFinalRespHbt(
        ...
        try {
            ...
            try {
                respHbt = XmlUtil.fromXml(rawXmlBody, RespHbt.class);
            } catch (Exception ex) {
