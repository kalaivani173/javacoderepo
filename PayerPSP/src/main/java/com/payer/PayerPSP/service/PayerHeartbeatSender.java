...
import com.payer.PayerPSP.dto.ReqHbt;
...
@Component
public class PayerHeartbeatSender {

    private static final Logger log = LoggerFactory.getLogger(PayerHeartbeatSender.class);
    ...
    @Value("${payer.orgId:156666}")
    private String payerOrgId;

    public PayerHeartbeatSender(HbtService hbtService, RestTemplate restTemplate) {
    ...
    public void sendHeartbeat() {
        try {
            ...
            String xml = XmlUtil.toXml(req, ReqHbt.class);
