...
@Component
    public class RemHeartbeatSender {

        private static final Logger log = LoggerFactory.getLogger(RemHeartbeatSender.class);
        ...
        @Value("${payer.orgId:159999}")
        private String payerOrgId;

        public RemHeartbeatSender(HbtService hbtService, RestTemplate restTemplate) {
